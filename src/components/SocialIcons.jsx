...
const SocialIcons = () => {
  return (
    <div className='hidden lg:flex top-[35%]  flex-col left-0 fixed w-1/12 text-white'>
      ...
      <div className='my-3 pl-2 bg-gray-600 ml-[-100px] hover:ml-[-1px] hover:rounded-r-md w-40 duration-300'><a href="./PiyushRai_resume.pdf" download={true} className='flex justify-between items-center'><span>Resume <  FaArrowDown className='relative inline'/> </span><img src={user} className='w-9 py-3 px-2' alt="" /></a></div>
    </div>
  )
}
